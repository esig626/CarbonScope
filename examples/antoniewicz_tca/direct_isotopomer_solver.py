...
This module intentionally imports neither FluxEMU nor another isotope engine.
It enumerates the full isotopomer state for the six balanced/product pools and
solves the 176-variable stationary balance directly with NumPy.
"""
...
def transition_matrix(source_carbons: int, destination_carbons: int, positions: tuple[int, ...]) -> np.ndarray:
...
__all__ = ["ACCOA", "ASPARTATE", "FLUXES", "glutamate_mid", "mass_isotopomer_distribution", "solve_stationary"]
