...
2. **Scientific shared-semantics parity:** native FluxEMU is compared with the exact mfapy-generated ODE system integrated with high-accuracy LSODA (`rtol=1e-9`, `atol=1e-12`). The original strict tolerances remain `2e-6` for Antoniewicz and `1e-5` for glucose-to-TCA; they were not relaxed.
