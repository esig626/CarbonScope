...
# Current terminology: the Bruno object is an order-specific Type-II lower bound.
# Keep the PR #18 class name importable for compatibility, but do not advertise it
# through the current public wildcard surface.
BrunoOrderBound = BrunoOrderCertificate
