...
def _without_optional_stacks(code):
    guard = """
        ...
        blocked = ('scipy', 'cobra', 'optlang', 'mfapy', 'matplotlib', 'jax')
...
def test_public_law_certificate_and_llr_execute_without_optional_stacks():
    _without_optional_stacks("""
        ...
        assert isinstance(result, BrunoOrderCertificate)
